    ...
    <div className="flex justify-center items-center h-screen">
      <div className="m-3 p-4 rounded shadow-lg md:w-2/5 border-2">
        ...
        <p className="text-center text-red-300 text-sm">{errorMsg}</p>
         ...
         <input type="text" className="border-2 p-2 w-full d-block mb-3"
          value={username}
          onChange={(e) => setUsername(e.target.value)}/>
         <label htmlFor="email">Email</label>
         <input type="email" className="border-2 p-2 w-full d-block mb-3"
         value={email}
         onChange={(e) => setEmail(e.target.value)}/>
         <label htmlFor="password">Password</label>
         <input type="password" className="border-2 p-2 w-full d-block mb-3"
         value={password}
