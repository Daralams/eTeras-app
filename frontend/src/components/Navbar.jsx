      ...
      <div className="p-4 bg-indigo-600">
        <div className="flex gap-3">
          <div className="flex items-center gap-2">
            ...
            <div
              className="bg-indigo-600 block fixed left-0 top-0 bottom-0 w-3/5 leading-[60px] h-screen transition-transform duration-500 ease-in-out z-50"
              style={open}
            >
              <div className="flex items-center justify-end">
                <button
                  className="flex items-center justify-end py-4 px-3 text-2xl text-white bg-transparent"
                  onClick={handleClick}
                >
                  <CgClose />
                </button>
              ...
              {isLoggin ? (
                <>
                  <NavLink
                    to="/dashboard"
                    className={({ isActive }) =>
                      `pl-6 w-full text-white flex items-center gap-2  ${
                        isActive ? "hover:bg-indigo-700" : ""
                      }`
                    }
                  >
                    <IoHome /> Dashboard
                  ...
                  <button
                    className="pl-6 w-full bg-transparent text-white flex items-center gap-2 hover:bg-indigo-700"
                    onClick={logout}
                  >
                    <CiLogout /> Logout
                  </button>
                ...
                <NavLink
                  to="/login"
                  className="pl-6 w-full text-white flex items-center gap-2 hover:hover:bg-indigo-700"
                >
                  <CiLogin /> Login
                </NavLink>
              )}
          ...
          <div className="flex justify-between items-center w-full">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* fitur theme ini sedang proses development, sementara diganti icon github dulu */}
              {/* <ThemeModeBtn/> */}
              <Link to="https://github.com/Daralams">
                <FaGithub className="ml-2 text-3xl text-white cursor-pointer" />
              </Link>
            </div>
          </div>
        </div>
